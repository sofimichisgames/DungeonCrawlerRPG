...
class DungeonGenerator {
    ...
    private fun pickItem(floor: Int): String {
        val table = when {
            floor >= 8 -> listOf(
                Config.ITEM_POTION_HP to 20, Config.ITEM_POTION_STR to 15,
                Config.ITEM_SCROLL_FIREBALL to 15, Config.ITEM_SCROLL_CONFUSE to 10,
                Config.ITEM_WEAPON_AXE to 15, Config.ITEM_ARMOR_PLATE to 15, Config.ITEM_GOLD to 10)
            floor >= 5 -> listOf(
                Config.ITEM_POTION_HP to 25, Config.ITEM_SCROLL_FIREBALL to 15,
                Config.ITEM_SCROLL_LIGHTNING to 10, Config.ITEM_WEAPON_SWORD to 15,
                Config.ITEM_WEAPON_AXE to 10, Config.ITEM_ARMOR_CHAIN to 10, Config.ITEM_GOLD to 15)
            floor >= 3 -> listOf(
                Config.ITEM_POTION_HP to 35, Config.ITEM_SCROLL_LIGHTNING to 15,
                Config.ITEM_WEAPON_SWORD to 15, Config.ITEM_ARMOR_LEATHER to 10,
                Config.ITEM_ARMOR_CHAIN to 5, Config.ITEM_GOLD to 20)
            else       -> listOf(
                Config.ITEM_POTION_HP to 50, Config.ITEM_WEAPON_DAGGER to 10,
                Config.ITEM_ARMOR_LEATHER to 10, Config.ITEM_GOLD to 30)
        }
        return weightedPick(table)
    }
